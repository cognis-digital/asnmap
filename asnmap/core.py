"""ASNMAP core — Map ASN/CIDR ownership & neighbors from whois/RIR exports."""
...
RULES = [
    ("ASN-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("ASN-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("ASN-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
